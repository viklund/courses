...
4. How many of the SNVs in the sampleid.mutect.vcf that were judged to be somatic by MuTects's post detection filter? Please use the apropriate combination of "grep" and "wc" to extract the information. 
