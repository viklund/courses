...
The data is part of a publicly available synthetic tumor data set that has been used for benchmarking mutation detection algorithms. Two tumor/normal sample pairs with sample ids HCC1143 and HCC1954 are available. You will start with .bam files that were generated according to GATK's best practice for variant discovery (tumor and normal .bam files were generated separately). 
