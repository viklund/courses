...
### Questions: 
3. How many unfiltered SNVs were detected by MuTect1?  
...
```
4. Describe in words what the above linux command does. Also, what command would you use if you would like to know how many lines in the .vcf file that contain meta data (starts with "#"). 
5. How many of the SNVs in the sampleid.mutect.vcf that were judged to be somatic by MuTects's post detection filter? Please use the apropriate combination of "grep" and "wc" to extract the information. 
