...
The convention is that "&lt;parameter&gt;" (or &lt;inputfile&gt;, &lt;outputfile&gt;, &lt;your directory&gt;, etc.) in the instructions means that you should insert your parameter in this space (e.g.input file, output file, directory, etc.)", never that you should literally type "&lt;parameter&gt;" into the computer.
