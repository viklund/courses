...
```bash
$ salloc -A g2016028 -t 07:00:00 -p core -n 1 --no-shell --reservation=g2016028_MON &
```
...
This course's project id is **g2016028**, so the path to the project folder is **/proj/g2016028**
