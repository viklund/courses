...
The files are located in the folder `/dev/shm/ngsintro/uppmax_pipeline_exercise/data`
...
$ cp -r /dev/shm/ngsintro/uppmax_pipeline_exercise/data ~/glob/ngs-intro/uppmax_pipeline_exercise
```
