...
Load the file in [Webapollo](http://bils-web.imbim.uu.se/drosophila_melanogaster). [Here find the WebApollo instruction](UsingWebapollo) Load the Ensembl annotation available in  ~/annotation\_course/course\_material/dmel/chromosome\_4/annotation
